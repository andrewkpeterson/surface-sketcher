...
v_neg = lambda_v < 0;
v_pos = lambda_v >= 0;
quiver(xs(u_neg), ys(u_neg), lambda_u(u_neg).*u1(u_neg), lambda_u(u_neg).*u2(u_neg), .5, "LineWidth", 2, "Color", [1,0,0], "ShowArrowHead", "on");
hold on;
quiver(xs(u_pos), ys(u_pos), lambda_u(u_pos).*u1(u_pos), lambda_u(u_pos).*u2(u_pos), .5, "LineWidth", 2, "Color", [0,0,1], "ShowArrowHead", "on");
quiver(xs(v_neg), ys(v_neg), lambda_v(v_neg).*v1(v_neg), lambda_v(v_neg).*v2(v_neg), .5, "LineWidth", 2, "Color", [1,0,0], "ShowArrowHead", "on");
quiver(xs(v_pos), ys(v_pos), lambda_v(v_pos).*v1(v_pos), lambda_v(v_pos).*v2(v_pos), .5, "LineWidth", 2, "Color", [0,0,1], "ShowArrowHead", "on");
